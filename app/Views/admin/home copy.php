    ...
    <div class="col-lg-6">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <p>For documentations Select2 you can visit <a href="<?= base_url() ?>/assets/https://select2.org/" target="_blank">here.</a></p>
            </div>
        </div>
    ...
    <div class="col-lg-6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <p>For documentations Bootstrap Datepicker you can visit <a href="<?= base_url() ?>/assets/https://github.com/uxsolutions/bootstrap-datepicker" target="_blank">here.</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <p>For documentations TouchSpin you can visit <a href="<?= base_url() ?>/assets/https://github.com/istvan-ujjmeszaros/bootstrap-touchspin" target="_blank">here.</a></p>
            </div>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <p>For documentations Clockpicker you can visit <a href="<?= base_url() ?>/assets/http://weareoutman.github.io/clockpicker/" target="_blank">here.</a></p>
            </div>
        </div>
    </div>
</div>
